...
const TherapyBot = () => {
  ...
  const speakText = async (text) => {
    ...
    const voice = voicesRef.current.find(v => v.lang.startsWith('en') && v.name.includes('Female')) || voicesRef.current[0];
  ...
  const startSession = async () => {
    const greeting = "Hello, I'm Dr. Sarah, your therapeutic AI assistant. I'm here to listen and support you. How are you feeling today?";
    ...
    <div className="max-w-2xl mx-auto p-4">
      <div className="bg-white rounded-lg shadow-xl">
        <div className="p-4 border-b">
          <h2 className="text-xl font-semibold text-gray-800">Therapy Session with Dr. Sarah</h2>
        </div>
