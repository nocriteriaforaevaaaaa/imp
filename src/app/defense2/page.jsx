...
import FBXViewer from "../defense/3dmodel";
...
function App() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <Button  onClick={handleNextExercise} className="bg-red-600 hover:bg-red-700">
                  Next Exercise
